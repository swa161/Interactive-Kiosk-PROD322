...
{
	//An outline that looks a bit nicer than the default one.
	//It has less "holes" in the outline by drawing more copies of the effect
	[HelpURL("https://makaka.org/unity-assets")]
	[AddComponentMenu("UI/Effects/Extensions/Smooth Outline")]
